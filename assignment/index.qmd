...
The world is still figuring out how to deal with large language models (LLMs) like ChatGPT. My view is that ChatGPT is not functionally different from searching through online forums, Google, etc., for how to complete coding tasks. This is *good practice*, and I don't want to discourage that, but there are limits:  

* *what is allowed*. You are allowed to use ChatGPT to figure out how to complete **coding** tasks (e.g., how do I make a barplot?)
* *what is not allowed*. You are not allowed to pass off ChatGPT's **writing** as if it was your own (e.g., submitting ChatGPT's interpretation of some graph or data pattern) or ChatGPT **code** as your own (e.g., mindlessly pasting ChatGPT code into your homework)
* *Be careful*. In my experience, these tools can be unreliable. Plus, if you over rely on them and don't develop an understanding of the mechanics, you'll likely suffer during the in-class exams. 
