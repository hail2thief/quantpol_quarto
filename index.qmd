...
**If you would like to speak with me about something that only pertains to you** (e.g., your grades, academic advice), you can sign up for office hours on [Calendly](https://calendly.com/juan-f-tellez/15min). If there's a time-sensitive issue you can email me. Everything else goes in the Slack so that others can see and access help. 
