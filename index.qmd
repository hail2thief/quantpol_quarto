...
- {{< fa user-graduate >}}  &nbsp; **Haley Darstaad** <br> {{< fa clock >}} &nbsp; M 3pm-4pm, W 12pm-2pm <br> {{< fa university >}} &nbsp; Kerr 569 <br> {{< fa envelope >}} &nbsp; hbdaarstad@ucdavis.edu
- {{< fa user-graduate >}}  &nbsp; **RyuGyung ("Rio") Park** <br> {{< fa clock >}} &nbsp; Tu 11am-12pm, 2pm-3pm <br> {{< fa university >}} &nbsp; Kerr 677 <br> {{< fa envelope >}} &nbsp; rgpark@ucdavis.edu
- {{< fa user-graduate >}}  &nbsp; **Jack Rametta** <br> {{< fa clock >}} &nbsp;  W 9am-12pm <br> {{< fa university >}} &nbsp; Kerr 566 <br> {{< fa envelope >}} &nbsp; jtrametta@ucdavis.edu
:::
...
All materials for this course are **free and online**. You will do all of your analysis with the open source (and free) programming language [R](https://cran.r-project.org/). You will use [RStudio](https://posit.co/) as the main program to access R. 
...
**Discussion section and TA office hours are other great places to get help**. TA office hours are listed at the top of this page.


**If you would like to speak with me about something that only pertains to you** (e.g., your grades, academic advice) or need help, you can sign up for office hours on [Calendly](https://calendly.com/juan-f-tellez/15min). If there's a time-sensitive issue you can email me. Everything else goes in the Slack so that others can see and access help. 
...
Once you have read this entire syllabus and [the assignments page](/assignment/), please post a picture or gif of a technology that you was **obsolete** by the time you were an adult on Slack. I'll round your final grade up to the nearest whole number; you’ve got until the end of week 2 of class.
