...
# Prediction vs. causality {.center background-color="`r full`"}
---
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/kaggle.png"))
```
:::
:::
...
# A turning point {.center background-color="`r full`"}
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/learning-R.png"))
```
:::
:::
...
knitr::include_graphics(here::here("slides/img/the-thing.png"))
```
:::
:::
...
# Many interesting questions are causal {.center background-color="`r full`"}
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/causal-job.png"))
```
:::
:::
...
::: {.column width="50%"}
```{r,out.width="70%"}
knitr::include_graphics(here::here("slides/img/hume.jpeg"))
```
:::
:::
...
# The problem with causality {.center background-color="`r full`"}
---
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/education.png"))
```
:::
:::
...
```{r,out.width="70%"}
knitr::include_graphics(here::here("slides/img/vote-id.png"))
```
...
```{r}
knitr::include_graphics(here::here("slides/img/spurious-cheese.png"))
```
...
knitr::include_graphics(here::here("slides/img/sponge-cause.jpeg"))
```
...
```{r, echo = TRUE}
fake_election = tibble(party_share = rnorm(n = 500, mean = 50, sd = 5), funding = rnorm(n = 500, mean = 20000, sd = 4000))
fake_election
```
...
```{r}
ggplot(fake_election, aes(x = funding)) + geom_histogram(fill = red, color = "white", alpha = .8)
```
...
```{r, echo = TRUE}
fake_election = tibble(party_share = rnorm(n = 500, mean = 50, sd = 5), funding = rnorm(n = 500, mean = 20000, sd = 4000) + 2000 * party_share)
fake_election
```
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/lacour.png"))
```
:::
:::
...
# So we (sometimes) *can* estimate causal effects {.center background-color="`r full`"}


# Where does it all go wrong then? {.center background-color="`r full`"}
...
1. A study on whether being a victim of a crime makes someone more supportive of authoritarian leaders


2. A study on whether post-*Dobbs* abortion restrictions reduced abortions
