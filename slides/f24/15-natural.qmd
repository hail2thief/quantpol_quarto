...
# A brief, unfair history of social science research  {.center background-color="`r full`"}
---
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/garbage-models.png"))
```
:::
:::
...
* From an academic article showing that dog ownership improves long-term health: 
...
::: {.column width="50%"}
```{r, out.width="80%"}
knitr::include_graphics(here::here("slides/img/morty.jpeg"))
```
:::
:::
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/causality.png"))
```
:::
:::
...
::: {.column width="50%"}
```{r, out.width="80%"}
knitr::include_graphics(here::here("slides/img/natural_experiments.jpeg"))
```
:::
:::
...
knitr::include_graphics(here::here("slides/img/card-nobel.jpeg"))
```
:::

::: {.column width="50%"}
```{r, out.width="60%", fig.align='center'}
knitr::include_graphics(here::here("slides/img/angrist-nobel.jpeg"))
```
:::
:::
...
# Regression discontinuity  {.center background-color=`r full`"}
---
...
::: {.column width="50%"}
```{r,out.width="80%"}
knitr::include_graphics(here::here("slides/img/gifted-kid2.jpeg"))
```
:::
:::
...
fake_students |> 
  sample_n(8) |> 
  select(Age, Grade, gifted, earnings) |> 
...
ggplot(fake_students, aes(x= earnings, y = gifted, 
                          color = gifted)) + 
  ...
  geom_label_repel(data = avgs, aes(label = paste0("Avg: ", scales::dollar(earnings))), 
                   size = 5, fontface = "bold", nudge_x = 30000, 
                   nudge_y = .02)
...
knitr::include_graphics(here::here("slides/img/phrenology.jpeg"))
```
:::
:::
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/gifted-kid.jpeg"))
```
:::
:::
...
# Other examples {.center background-color="`r full`"}
---
...
```{r, out.width="60%", fig.align='center'}
knitr::include_graphics(here::here("slides/img/diamond-rd.png"))
```
...
knitr::include_graphics(here::here("slides/img/diamond-rd-graph.png"))
```
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/dell-vietnam.png"))
```
:::
:::
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/lottery-machine.jpeg"))
```
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/scales.png"))
```
...
# Limitations {.center background-color="`r full`"}
---
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/school-lunch.png"))
```
