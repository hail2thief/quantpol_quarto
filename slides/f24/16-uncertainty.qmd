...
```{r, out.width="80%"}
knitr::include_graphics(here::here("slides/img/polls.png"))
```
...
```{r, out.width="80%"}
knitr::include_graphics(here::here("slides/img/margin-of-error.jpeg"))
```
...
# Why are we uncertain? {.center background-color="`r full`"}
...
```{r}
knitr::include_graphics(here::here("slides/img/heights.png"))
```
...
knitr::include_graphics(here::here("slides/img/MPP_map1.jpeg"))
```
:::
:::
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/bernoulli.png"))
```
:::
:::
...
knitr::include_graphics(here::here("slides/img/samples.jpg"))
```
:::
:::
...
knitr::include_graphics(here::here("slides/img/phone-surveys.png"))
```
...
::: {.column width="50%"}
```{r}
knitr::include_graphics(here::here("slides/img/samples-cheese.jpeg"))
```
:::
:::
