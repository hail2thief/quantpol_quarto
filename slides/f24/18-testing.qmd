...
# Making inferences with data {.center background-color="`r full`"}
...
# Where to go from here? {.center background-color="`r full`"}
...
# See you at the final {.center background-color="`r full`"}
